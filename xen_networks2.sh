...
xe pif-reconfigure-ip IP=192.168.100.44 netmask=255.255.255.0 gateway=192.168.100.1 mode=static uuid=$eth0_pif_uuid
...
xe pif-reconfigure-ip IP=192.168.217.14 netmask=255.255.255.0 gateway=192.168.217.1 mode=static uuid=$eth1_pif_uuid
...
xe pif-reconfigure-ip IP=172.16.16.14 netmask=255.255.255.0 gateway=172.16.16.1 mode=static uuid=$eth2_pif_uuid
