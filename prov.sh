...
PSTESTS="test_deploy_vm_root_resize test_deploy_vm_with_userdata test_hosts test_internal_lb test_loadbalance test_scale_vm test_snapshots test_vm_snapshots"
