...
xe pif-reconfigure-ip IP=192.168.100.42 netmask=255.255.255.0 gateway=192.168.100.1 mode=static uuid=$eth0_pif_uuid
...
xe pif-reconfigure-ip IP=192.168.217.12 netmask=255.255.255.0 gateway=192.168.217.1 mode=static uuid=$eth1_pif_uuid
...
xe pif-reconfigure-ip IP=172.16.16.12 netmask=255.255.255.0 gateway=172.16.16.1 mode=static uuid=$eth2_pif_uuid
