...
UPDATE cloud.vm_template SET guest_os_id=99, url="http://192.168.217.11/macchinina-xen.vhd.bz2" WHERE unique_name="centos56-x86_64-xen";
UPDATE cloud.vm_template SET guest_os_id=99,url="http://192.168.217.11/macchinina-kvm.qcow2.bz2" WHERE unique_name="centos55-x86_64";
...
#UPDATE cloud.configuration SET value="ShapeBlue-CCS-Template" WHERE name="cloud.container.cluster.template.name";
