...
# ************************ Create Zone ************************
zone_id=`$cli create zone dns1=$dns_ext1 internaldns1=$dns_int1 name=$zone_name networktype=Advanced guestcidraddress=$guest_cidr localstorageenabled=true | grep ^id\ = | awk '{print $3}'` 
...
#get os type id
ostype_id=`$cli list ostypes description="Other Linux (64-bit)"  | grep ^id\ = | awk '{print $3}'`
