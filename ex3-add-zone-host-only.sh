...
p1_cluster1_host_ip=192.168.217.16
p1_cluster1_host2_ip=192.168.217.18
...
ssh root@192.168.217.18 'sh /root/cloud-setup-bonding.sh'
ssh root@192.168.217.18 'xe pool-join master-address=192.168.217.16 master-username=root master-password=password'
