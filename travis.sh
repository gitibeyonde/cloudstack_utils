...
#new simulator tests = test_acl_isolatednetwork

#STESTS="test_affinity_groups"
...
CTESTS="test_deploy_vm_userdata_reg test_dynamic_compute_offering test_acl_listsnapshot test_mm_domain_limits test_network_offeringtest_snapshot_limits test_snapshotstest_vpc_vm_life_cycle test_dynamic_compute_offering test_snapshot_gctest_volumes test_escalations_snapshots test_escalations_templates"
