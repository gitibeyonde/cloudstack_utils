...
UPDATE cloud.configuration SET value="192.168.100.0/24" WHERE name="secstorage.allowed.internal.sites";
UPDATE cloud.configuration SET value="192.168.100.0/24" WHERE name="management.network.cidr";
UPDATE cloud.configuration SET value="192.168.100.41" WHERE name="host";
...
UPDATE cloud.vm_template SET url="http://192.168.100.41/centos56-x86_64.vhd.bz2" WHERE unique_name="centos56-x86_64-xen";
